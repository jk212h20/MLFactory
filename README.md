...
| 1 | Env protocol, tic-tac-toe, Connect 4, vanilla UCT MCTS, arena | ⏳ Next |
| 2 | Boop rules ported from `Boop/server/src/game/GameState.ts`; 10k-game Python↔TS parity test; symmetry group | ⏳ |
